...
import programmer.zaman.now.reflection.data.Product;
...
public class RecordTest {
    ...
    @Test
    void testGetRecordValu() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Class<Product> productClass = Product.class;
        Method id = productClass.getDeclaredMethod("id");

        Product product = new Product("1", "Apple Iphone", 20_000_000L);
